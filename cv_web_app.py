...
def prediction(net):   
    # Draw or clear?
    drawing_mode = 'freedraw' if st.checkbox("Draw or clear?",True) else 'transform'

    # Create a canvas component
    result = st_canvas(
        stroke_width=15, stroke_color='#FFF', background_color='#000', height=280,width=280, drawing_mode=drawing_mode, key="canvas"
    )
